...
var g_limit;
var g_skip;
var g_FetchNextHourlyOEEValues;
...
function TablePaginationActions(props) {
  ...
  const lastPage = count/rowsPerPage - 1 // 0 based pages, 50 rows fetched at a time
...
export default function OEEPartTable({ total, limit, skip, data, push, FetchNextHourlyOEEValues }) {
  g_total=total;
  g_limit=limit;
  g_skip=skip;
  g_FetchNextHourlyOEEValues=FetchNextHourlyOEEValues;
